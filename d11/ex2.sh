...
function get_distance() {
  ...
  # echo "galaxy one ${galaxy_one[@]}" >&2
  # echo "galaxy two ${galaxy_two[@]}" >&2
  # echo "galaxies dist "$((dist_i + dist_j)) >&2
  # echo "expension ${expension[@]}" >&2
  # echo "expension dist ${#expension[@]}" >&2

  echo $(( dist_i + dist_j + ( ${#expension[@]} * (1000000 - 1) ) ))
}
